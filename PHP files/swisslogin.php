...
<ul style="border-bottom:none;border-top:none;background-color:transparent;position:top;font-size:20px;">
	...
	<li style="border-right:none; border-left:none;"><a href="swissfill.html">Go Back</a></li>
</ul>
	<h1 style="color:#D4AF37;letter-spacing: 10px; font-size:60px;"><em><strong><br>BOOKING DETAILS</strong></em><br><p style="font-size:45px;">SWITZERLAND<p></h1><br><br>
</div><br>
...
{
	 trigger_error("ENTER CORRECT CHECK IN AND CHECK OUT DATES");exit(0);
